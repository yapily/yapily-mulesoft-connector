...
public abstract class GetIdentityOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/identity";
  ...
  public GetIdentityOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetIdentityOperationBase() {
    super();
  }
  ...
  protected void getIdentityMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String consentHeader,
