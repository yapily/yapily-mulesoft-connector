...
public abstract class DeleteOperationBase extends BaseRestOperation {
  ...
  public DeleteOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public DeleteOperationBase() {
    super();
  }
  ...
  protected void deleteMain(
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addQueryParam("forceDelete", forceDeleteQueryParam);
    doRequest(
        config,
        connection,
        builder,
