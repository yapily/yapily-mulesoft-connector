...
import com.mulesoft.connectors.yapily.internal.metadata.GetStatementsOutputMetadataResolver;
import com.mulesoft.connectors.yapily.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.yapily.internal.operation.refinement.GetStatementsOperationRefinement;
...
public class GetStatementsOperation extends GetStatementsOperationRefinement {
  public GetStatementsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetStatementsOperation() {
    super();
  }

  /**
   * Used to get the list of statements for an account.<br>
   * <br>
   * Feature: `ACCOUNT_STATEMENTS`
   *
   * <p>This operation makes an HTTP GET request to the /accounts/{accountId}/statements endpoint
   *
  ...
  @OutputResolver(
      output = GetStatementsOutputMetadataResolver.class,
