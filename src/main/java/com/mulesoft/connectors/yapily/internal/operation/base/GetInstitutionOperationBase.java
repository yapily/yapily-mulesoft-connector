...
public abstract class GetInstitutionOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/institutions/{institutionId}";
  ...
  public GetInstitutionOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetInstitutionOperationBase() {
    super();
  }
  ...
  protected void getInstitutionMain(
      RestConfiguration config,
      RestConnection connection,
      String institutionIdUriParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addUriParam("institutionId", institutionIdUriParam);
    doRequest(
        config,
        connection,
        builder,
