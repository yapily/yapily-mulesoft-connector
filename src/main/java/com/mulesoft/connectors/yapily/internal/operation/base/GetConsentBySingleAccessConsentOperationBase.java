...
public abstract class GetConsentBySingleAccessConsentOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/consent-one-time-token";
  ...
  public GetConsentBySingleAccessConsentOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetConsentBySingleAccessConsentOperationBase() {
    super();
  }

  protected void getConsentBySingleAccessConsent(
    ...
    try {
      ...
      getConsentBySingleAccessConsentMain(
          config,
          connection,
          customParameterBindings,
          getConsentBySingleAccessConsentBody,
          parameters,
          overrides,
          callback);
  ...
  protected void getConsentBySingleAccessConsentMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(getConsentBySingleAccessConsentBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
