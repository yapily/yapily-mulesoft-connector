...
public abstract class UpdateEmbeddedPaymentAuthorisationOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/embedded-payment-auth-requests/{consentId}";
  ...
  public UpdateEmbeddedPaymentAuthorisationOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public UpdateEmbeddedPaymentAuthorisationOperationBase() {
    super();
  }

  protected void updateEmbeddedPaymentAuthorisation(
    ...
    try {
      ...
      updateEmbeddedPaymentAuthorisationMain(
          config,
          connection,
          consentIdUriParam,
          rawQueryParam,
  ...
  protected void updateEmbeddedPaymentAuthorisationMain(
      RestConfiguration config,
      RestConnection connection,
      String consentIdUriParam,
      boolean rawQueryParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(updateEmbeddedPaymentAuthorisationBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
