...
public abstract class CreatePreAuthorisationRequestOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/pre-auth-requests";
  ...
  public CreatePreAuthorisationRequestOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreatePreAuthorisationRequestOperationBase() {
    super();
  }

  protected void createPreAuthorisationRequest(
    ...
    try {
      ...
      createPreAuthorisationRequestMain(
          config,
          connection,
          rawQueryParam,
  ...
  protected void createPreAuthorisationRequestMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createPreAuthorisationRequestBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
