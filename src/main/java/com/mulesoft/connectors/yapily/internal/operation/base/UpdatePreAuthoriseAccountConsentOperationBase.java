...
public abstract class UpdatePreAuthoriseAccountConsentOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/account-auth-requests";
  ...
  public UpdatePreAuthoriseAccountConsentOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public UpdatePreAuthoriseAccountConsentOperationBase() {
    super();
  }

  protected void updatePreAuthoriseAccountConsent(
    ...
    try {
      ...
      updatePreAuthoriseAccountConsentMain(
          config,
          connection,
          rawQueryParam,
          consentHeader,
  ...
  protected void updatePreAuthoriseAccountConsentMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String consentHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(updatePreAuthoriseAccountConsentBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
