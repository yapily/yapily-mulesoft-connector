...
public abstract class GetConsentByIdOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/consents/{consentId}";
  ...
  public GetConsentByIdOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetConsentByIdOperationBase() {
    super();
  }

  protected void getConsentById(
  ...
  protected void getConsentByIdMain(
      RestConfiguration config,
      RestConnection connection,
      String consentIdUriParam,
