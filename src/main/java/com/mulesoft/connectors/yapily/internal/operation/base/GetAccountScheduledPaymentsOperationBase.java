...
public abstract class GetAccountScheduledPaymentsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/accounts/{accountId}/scheduled-payments";
  ...
  public GetAccountScheduledPaymentsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetAccountScheduledPaymentsOperationBase() {
    super();
  }

  protected void getAccountScheduledPayments(
    ...
    try {
      ...
      getAccountScheduledPaymentsMain(
          config,
          connection,
          accountIdUriParam,
          limitQueryParam,
  ...
  protected void getAccountScheduledPaymentsMain(
      RestConfiguration config,
      RestConnection connection,
      String accountIdUriParam,
      Integer limitQueryParam,
