...
public abstract class GetInstitutionsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/institutions";
  ...
  public GetInstitutionsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetInstitutionsOperationBase() {
    super();
  }
  ...
  protected void getInstitutionsMain(
      RestConfiguration config,
      RestConnection connection,
