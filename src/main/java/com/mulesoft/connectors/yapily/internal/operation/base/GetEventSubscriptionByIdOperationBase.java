...
public abstract class GetEventSubscriptionByIdOperationBase extends BaseRestOperation {
  ...
  public GetEventSubscriptionByIdOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetEventSubscriptionByIdOperationBase() {
    super();
  }

  protected void getEventSubscriptionById(
  ...
  protected void getEventSubscriptionByIdMain(
      RestConfiguration config,
      RestConnection connection,
      String eventTypeIdUriParam,
