...
public abstract class GetAccountPeriodicPaymentsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/accounts/{accountId}/periodic-payments";
  ...
  public GetAccountPeriodicPaymentsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetAccountPeriodicPaymentsOperationBase() {
    super();
  }

  protected void getAccountPeriodicPayments(
    ...
    try {
      ...
      getAccountPeriodicPaymentsMain(
          config,
          connection,
          accountIdUriParam,
          limitQueryParam,
  ...
  protected void getAccountPeriodicPaymentsMain(
      RestConfiguration config,
      RestConnection connection,
      String accountIdUriParam,
      Integer limitQueryParam,
