...
public abstract class CreateEventSubscriptionOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/notifications/event-subscriptions";
  ...
  public CreateEventSubscriptionOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreateEventSubscriptionOperationBase() {
    super();
  }
  ...
  protected void createEventSubscriptionMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createEventSubscriptionBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
