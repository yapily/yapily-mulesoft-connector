...
public abstract class GetStatementOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/accounts/{accountId}/statements/{statementId}";
  ...
  public GetStatementOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetStatementOperationBase() {
    super();
  }
  ...
  protected void getStatementMain(
      RestConfiguration config,
      RestConnection connection,
      String accountIdUriParam,
      String statementIdUriParam,
