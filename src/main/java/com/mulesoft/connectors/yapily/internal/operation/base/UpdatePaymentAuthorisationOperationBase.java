...
public abstract class UpdatePaymentAuthorisationOperationBase extends BaseRestOperation {
  ...
  public UpdatePaymentAuthorisationOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public UpdatePaymentAuthorisationOperationBase() {
    super();
  }

  protected void updatePaymentAuthorisation(
    ...
    try {
      ...
      updatePaymentAuthorisationMain(
          config,
          connection,
          rawQueryParam,
          psuIdHeader,
  ...
  protected void updatePaymentAuthorisationMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String psuIdHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(updatePaymentAuthorisationBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
