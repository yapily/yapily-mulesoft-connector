...
public abstract class GetAccountsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/accounts";
  ...
  public GetAccountsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetAccountsOperationBase() {
    super();
  }
  ...
  protected void getAccountsMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String consentHeader,
