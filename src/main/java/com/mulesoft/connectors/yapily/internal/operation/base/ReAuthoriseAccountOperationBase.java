...
public abstract class ReAuthoriseAccountOperationBase extends BaseRestOperation {
  ...
  public ReAuthoriseAccountOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public ReAuthoriseAccountOperationBase() {
    super();
  }

  protected void reAuthoriseAccount(
  ...
  protected void reAuthoriseAccountMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String consentHeader,
