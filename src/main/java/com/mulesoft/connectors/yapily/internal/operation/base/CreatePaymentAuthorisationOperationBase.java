...
public abstract class CreatePaymentAuthorisationOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/payment-auth-requests";
  ...
  public CreatePaymentAuthorisationOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreatePaymentAuthorisationOperationBase() {
    super();
  }

  protected void createPaymentAuthorisation(
    ...
    try {
      ...
      createPaymentAuthorisationMain(
          config,
          connection,
          rawQueryParam,
          psuIdHeader,
  ...
  protected void createPaymentAuthorisationMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String psuIdHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createPaymentAuthorisationBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
