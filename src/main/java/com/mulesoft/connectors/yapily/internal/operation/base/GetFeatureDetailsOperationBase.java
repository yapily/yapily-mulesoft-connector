...
public abstract class GetFeatureDetailsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/features";
  ...
  public GetFeatureDetailsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetFeatureDetailsOperationBase() {
    super();
  }
  ...
  protected void getFeatureDetailsMain(
      RestConfiguration config,
      RestConnection connection,
