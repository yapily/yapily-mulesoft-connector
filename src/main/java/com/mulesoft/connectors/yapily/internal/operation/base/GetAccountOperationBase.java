...
public abstract class GetAccountOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/accounts/{accountId}";
  ...
  public GetAccountOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetAccountOperationBase() {
    super();
  }
