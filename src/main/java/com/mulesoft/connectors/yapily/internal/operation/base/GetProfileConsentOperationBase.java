...
public abstract class GetProfileConsentOperationBase extends BaseRestOperation {
  ...
  public GetProfileConsentOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetProfileConsentOperationBase() {
    super();
  }

  protected void getProfileConsent(
  ...
  protected void getProfileConsentMain(
      RestConfiguration config,
      RestConnection connection,
      String userUuidUriParam,
      String profileConsentIdUriParam,
