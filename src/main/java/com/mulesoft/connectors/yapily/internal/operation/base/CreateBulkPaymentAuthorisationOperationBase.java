...
public abstract class CreateBulkPaymentAuthorisationOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/bulk-payment-auth-requests";
  ...
  public CreateBulkPaymentAuthorisationOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreateBulkPaymentAuthorisationOperationBase() {
    super();
  }

  protected void createBulkPaymentAuthorisation(
    ...
    try {
      ...
      createBulkPaymentAuthorisationMain(
          config,
          connection,
          rawQueryParam,
          psuIdHeader,
  ...
  protected void createBulkPaymentAuthorisationMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String psuIdHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createBulkPaymentAuthorisationBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
