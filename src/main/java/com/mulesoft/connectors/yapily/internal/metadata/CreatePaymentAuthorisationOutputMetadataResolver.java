...
public class CreatePaymentAuthorisationOutputMetadataResolver extends JsonOutputMetadataResolver {
  @Override
  ...
  public String getResolverName() {
    return "create-payment-authorisation-output-type-resolver";
  }
