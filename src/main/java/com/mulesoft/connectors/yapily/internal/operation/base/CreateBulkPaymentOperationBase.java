...
public abstract class CreateBulkPaymentOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/bulk-payments";
  ...
  public CreateBulkPaymentOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreateBulkPaymentOperationBase() {
    super();
  }

  protected void createBulkPayment(
  ...
  protected void createBulkPaymentMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String consentHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createBulkPaymentBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
