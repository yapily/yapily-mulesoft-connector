...
public abstract class CreateProfileConsentOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/users/{userUuid}/profile/consents";
  ...
  public CreateProfileConsentOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreateProfileConsentOperationBase() {
    super();
  }

  protected void createProfileConsent(
  ...
  protected void createProfileConsentMain(
      RestConfiguration config,
      RestConnection connection,
      String userUuidUriParam,
      String consentHeader,
