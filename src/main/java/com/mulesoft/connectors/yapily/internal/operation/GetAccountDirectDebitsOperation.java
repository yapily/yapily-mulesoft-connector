...
import com.mulesoft.connectors.yapily.internal.metadata.GetAccountDirectDebitsOutputMetadataResolver;
import com.mulesoft.connectors.yapily.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.yapily.internal.operation.refinement.GetAccountDirectDebitsOperationRefinement;
...
public class GetAccountDirectDebitsOperation extends GetAccountDirectDebitsOperationRefinement {
  public GetAccountDirectDebitsOperation(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetAccountDirectDebitsOperation() {
    super();
  }

  /**
   * Used to get the list of direct debits for an account.<br>
   * <br>
   * Feature: `ACCOUNT_DIRECT_DEBIT`
   *
   * <p>This operation makes an HTTP GET request to the /accounts/{accountId}/direct-debits endpoint
   *
  ...
  @DisplayName("Get Account Direct Debits")
  @Summary(
      "Used to get the list of direct debits for an account.<br><br>Feature: `ACCOUNT_DIRECT_DEBIT`")
  @MediaType("application/json;charset=UTF-8")
  @OutputResolver(
      output = GetAccountDirectDebitsOutputMetadataResolver.class,
      attributes = HttpResponseAttributesMetadataResolver.class)
  public void getAccountDirectDebits(
