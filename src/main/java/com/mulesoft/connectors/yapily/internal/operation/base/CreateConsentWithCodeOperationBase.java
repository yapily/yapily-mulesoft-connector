...
public abstract class CreateConsentWithCodeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/consent-auth-code";
  ...
  public CreateConsentWithCodeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreateConsentWithCodeOperationBase() {
    super();
  }

  protected void createConsentWithCode(
    ...
    try {
      ...
      createConsentWithCodeMain(
          config,
          connection,
          customParameterBindings,
          createConsentWithCodeBody,
          parameters,
          overrides,
          callback);
  ...
  protected void createConsentWithCodeMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createConsentWithCodeBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
