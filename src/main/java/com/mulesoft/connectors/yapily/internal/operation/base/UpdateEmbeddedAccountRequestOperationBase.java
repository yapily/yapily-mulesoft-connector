...
public abstract class UpdateEmbeddedAccountRequestOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/embedded-account-auth-requests/{consentId}";
  ...
  public UpdateEmbeddedAccountRequestOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public UpdateEmbeddedAccountRequestOperationBase() {
    super();
  }

  protected void updateEmbeddedAccountRequest(
    ...
    try {
      ...
      updateEmbeddedAccountRequestMain(
          config,
          connection,
          consentIdUriParam,
          rawQueryParam,
  ...
  protected void updateEmbeddedAccountRequestMain(
      RestConfiguration config,
      RestConnection connection,
      String consentIdUriParam,
      boolean rawQueryParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(updateEmbeddedAccountRequestBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
