...
public abstract class GetPaymentsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/payments/{paymentId}/details";
  ...
  public GetPaymentsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetPaymentsOperationBase() {
    super();
  }
  ...
  protected void getPaymentsMain(
      RestConfiguration config,
      RestConnection connection,
      String paymentIdUriParam,
      boolean rawQueryParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addUriParam("paymentId", paymentIdUriParam)
