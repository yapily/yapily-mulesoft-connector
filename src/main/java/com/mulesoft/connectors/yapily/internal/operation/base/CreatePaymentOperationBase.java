...
public abstract class CreatePaymentOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/payments";
  ...
  public CreatePaymentOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreatePaymentOperationBase() {
    super();
  }
  ...
  protected void createPaymentMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String consentHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createPaymentBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
