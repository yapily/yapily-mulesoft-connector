...
public abstract class GetApplicationMeOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/me";
  ...
  public GetApplicationMeOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetApplicationMeOperationBase() {
    super();
  }

  protected void getApplicationMe(
    ...
    try {
      ...
      getApplicationMeMain(
          config, connection, customParameterBindings, parameters, overrides, callback);
  ...
  protected void getApplicationMeMain(
      RestConfiguration config,
      RestConnection connection,
