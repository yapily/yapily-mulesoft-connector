...
public abstract class InitiateAccountRequestOperationBase extends BaseRestOperation {
  ...
  public InitiateAccountRequestOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public InitiateAccountRequestOperationBase() {
    super();
  }

  protected void initiateAccountRequest(
  ...
  protected void initiateAccountRequestMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String psuIdHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(initiateAccountRequestBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
