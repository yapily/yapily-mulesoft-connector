...
public abstract class InitiateEmbeddedAccountRequestOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/embedded-account-auth-requests";
  ...
  public InitiateEmbeddedAccountRequestOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public InitiateEmbeddedAccountRequestOperationBase() {
    super();
  }

  protected void initiateEmbeddedAccountRequest(
    ...
    try {
      ...
      initiateEmbeddedAccountRequestMain(
          config,
          connection,
          rawQueryParam,
          psuIdHeader,
  ...
  protected void initiateEmbeddedAccountRequestMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String psuIdHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(initiateEmbeddedAccountRequestBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
