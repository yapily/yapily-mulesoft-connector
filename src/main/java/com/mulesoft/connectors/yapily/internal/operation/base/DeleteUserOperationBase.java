...
public abstract class DeleteUserOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/users/{userUuid}";
  ...
  public DeleteUserOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public DeleteUserOperationBase() {
    super();
  }
