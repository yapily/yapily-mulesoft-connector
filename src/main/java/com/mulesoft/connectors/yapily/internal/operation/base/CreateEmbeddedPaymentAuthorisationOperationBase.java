...
public abstract class CreateEmbeddedPaymentAuthorisationOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/embedded-payment-auth-requests";
  ...
  public CreateEmbeddedPaymentAuthorisationOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreateEmbeddedPaymentAuthorisationOperationBase() {
    super();
  }

  protected void createEmbeddedPaymentAuthorisation(
    ...
    try {
      ...
      createEmbeddedPaymentAuthorisationMain(
          config,
          connection,
          rawQueryParam,
          psuIdHeader,
  ...
  protected void createEmbeddedPaymentAuthorisationMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String psuIdHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createEmbeddedPaymentAuthorisationBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
