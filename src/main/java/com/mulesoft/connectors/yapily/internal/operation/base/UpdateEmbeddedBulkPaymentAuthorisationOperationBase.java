...
public abstract class UpdateEmbeddedBulkPaymentAuthorisationOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/embedded-bulk-payment-auth-requests/{consentId}";
  ...
  public UpdateEmbeddedBulkPaymentAuthorisationOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public UpdateEmbeddedBulkPaymentAuthorisationOperationBase() {
    super();
  }

  protected void updateEmbeddedBulkPaymentAuthorisation(
    ...
    try {
      ...
      updateEmbeddedBulkPaymentAuthorisationMain(
          config,
          connection,
          consentIdUriParam,
          rawQueryParam,
  ...
  protected void updateEmbeddedBulkPaymentAuthorisationMain(
      RestConfiguration config,
      RestConnection connection,
      String consentIdUriParam,
      boolean rawQueryParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addUriParam("consentId", consentIdUriParam)
            ...
            .setBody(updateEmbeddedBulkPaymentAuthorisationBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
