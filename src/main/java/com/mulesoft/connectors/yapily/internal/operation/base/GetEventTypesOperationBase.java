...
public abstract class GetEventTypesOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/notifications/event-types";
  ...
  public GetEventTypesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetEventTypesOperationBase() {
    super();
  }
  ...
  protected void getEventTypesMain(
      RestConfiguration config,
      RestConnection connection,
