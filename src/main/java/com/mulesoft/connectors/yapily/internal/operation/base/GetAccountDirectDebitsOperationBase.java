...
public abstract class GetAccountDirectDebitsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/accounts/{accountId}/direct-debits";
  ...
  public GetAccountDirectDebitsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetAccountDirectDebitsOperationBase() {
    super();
  }

  protected void getAccountDirectDebits(
  ...
  protected void getAccountDirectDebitsMain(
      RestConfiguration config,
      RestConnection connection,
      String accountIdUriParam,
      Integer limitQueryParam,
