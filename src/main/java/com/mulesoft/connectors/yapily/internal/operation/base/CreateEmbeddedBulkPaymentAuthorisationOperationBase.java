...
public abstract class CreateEmbeddedBulkPaymentAuthorisationOperationBase
    extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/embedded-bulk-payment-auth-requests";
  ...
  public CreateEmbeddedBulkPaymentAuthorisationOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreateEmbeddedBulkPaymentAuthorisationOperationBase() {
    super();
  }

  protected void createEmbeddedBulkPaymentAuthorisation(
    ...
    try {
      ...
      createEmbeddedBulkPaymentAuthorisationMain(
          config,
          connection,
          rawQueryParam,
          psuIdHeader,
  ...
  protected void createEmbeddedBulkPaymentAuthorisationMain(
      RestConfiguration config,
      RestConnection connection,
      boolean rawQueryParam,
      String psuIdHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createEmbeddedBulkPaymentAuthorisationBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
