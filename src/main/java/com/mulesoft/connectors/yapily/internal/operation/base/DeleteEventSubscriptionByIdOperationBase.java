...
public abstract class DeleteEventSubscriptionByIdOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/notifications/event-subscriptions/{eventTypeId}";
  ...
  public DeleteEventSubscriptionByIdOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public DeleteEventSubscriptionByIdOperationBase() {
    super();
  }

  protected void deleteEventSubscriptionById(
      RestConfiguration config,
      RestConnection connection,
      String eventTypeIdUriParam,
      RequestParameters parameters,
      ConfigurationOverrides overrides,
      CompletionCallback<InputStream, Object> callback) {
    try {
      Map<String, Object> customParameterBindings = new HashMap<>();
      deleteEventSubscriptionByIdMain(
          config,
          connection,
          eventTypeIdUriParam,
  ...
  protected void deleteEventSubscriptionByIdMain(
      RestConfiguration config,
      RestConnection connection,
      String eventTypeIdUriParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addUriParam("eventTypeId", eventTypeIdUriParam);
    doRequest(
        config,
        connection,
        builder,
