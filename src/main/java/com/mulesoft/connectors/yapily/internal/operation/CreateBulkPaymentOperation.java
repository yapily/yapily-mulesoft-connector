...
import com.mulesoft.connectors.yapily.internal.metadata.CreateBulkPaymentInputMetadataResolver;
import com.mulesoft.connectors.yapily.internal.metadata.CreateBulkPaymentOutputMetadataResolver;
import com.mulesoft.connectors.yapily.internal.metadata.HttpResponseAttributesMetadataResolver;
import com.mulesoft.connectors.yapily.internal.operation.refinement.CreateBulkPaymentOperationRefinement;
...
public class CreateBulkPaymentOperation extends CreateBulkPaymentOperationRefinement {
  public CreateBulkPaymentOperation(ExpressionLanguage arg0) {
    super(arg0);
  }

  public CreateBulkPaymentOperation() {
    super();
  }

  /**
   * Used to initiate a bulk payment after obtaining the user's authorisation. <br>
   * <br>
   * Feature: `CREATE_BULK_PAYMENT`
   *
   * <p>This operation makes an HTTP POST request to the /bulk-payments endpoint
   *
  ...
  public void createBulkPayment(
      ...
      @Content(primary = true)
          @DisplayName("Body")
          @Summary("The payment request object defining the details of the bulk payment")
          @TypeResolver(CreateBulkPaymentInputMetadataResolver.class)
          TypedValue<InputStream> createBulkPaymentBody,
      @ParameterGroup(name = REQUEST_PARAMETERS_GROUP_NAME) RequestParameters parameters,
      @ParameterGroup(name = CONNECTOR_OVERRIDES) ConfigurationOverrides overrides,
      CompletionCallback<InputStream, Object> callback) {
    super.createBulkPayment(
        config,
        connection,
        rawQueryParam,
        consentHeader,
