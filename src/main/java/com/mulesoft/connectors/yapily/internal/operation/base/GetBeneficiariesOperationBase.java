...
public abstract class GetBeneficiariesOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/accounts/{accountId}/beneficiaries";
  ...
  public GetBeneficiariesOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  public GetBeneficiariesOperationBase() {
    super();
  }

  protected void getBeneficiaries(
  ...
  protected void getBeneficiariesMain(
      RestConfiguration config,
      RestConnection connection,
      String accountIdUriParam,
      boolean rawQueryParam,
